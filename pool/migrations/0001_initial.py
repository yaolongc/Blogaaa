# Generated by Django 2.2.6 on 2019-10-21 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(upload_to='%Y/%m/%d', verbose_name='图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=70, verbose_name='链接名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='%Y/%m/%d', verbose_name='文章图片')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pool.Category')),
                ('tags', models.ManyToManyField(blank=True, to='pool.Tag', verbose_name='标签')),
                ('tui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pool.Tui', verbose_name='推荐位')),
